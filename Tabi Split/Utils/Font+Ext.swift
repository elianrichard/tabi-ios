...
extension Font {
    ...
    static let tabiTitle1 = Font.custom(UIConfig.Font.Name.Bold, size: UIConfig.Font.Size.Title1)
    static let tabiTitle2 = Font.custom(UIConfig.Font.Name.Semibold, size: UIConfig.Font.Size.Title2)
